<main class="py-5">
    ...
    <div class="lead my-3 mx-5">
        ...
        <p class="lead"><?php echo $_SESSION['login'][0]['Role']; ?></p>
        <div class="d-flex flex-row text-start">
            ...
            <div class="w-25">
                <p><?php
                $date = strtotime($_SESSION['login'][0]['NgaySinh']);
                echo date('m/d/Y', $date); ?></p>
                <p><?php echo $_SESSION['login'][0]['SDT']; ?></p>
                <p><?php echo $_SESSION['login'][0]['CMND']; ?></p>
                <p><?php echo $_SESSION['login'][0]['DiaChi']; ?></p>
            </div>
        </div>
        <hr>
        <div class="d-flex flex-row justify-content-between">
            <div>
                ...
                <p id="idtt" data-address-id="<?php echo $addressInfoId['IdTinhThanh']; ?>"><?php echo $addressInfo['TenTinhThanh']; ?></p>
            </div>
            <div>
        ...
        <div class="d-flex flex-row justify-content-between mt-4">
            ...
            <div>
                <a href="#" class="btn py-2 rounded bg-light">
            ...
            <div class="modal-body p-5 pt-0">
                <form action="#" method="post">
                    ...
                    <select name="role" id="role" class="form-select mb-3">
                        <option value="Người Bán" selected>Chủ cửa hàng</option>
                        <option value="Người Mua">Khách hàng</option>
                    </select>
                    ...
                    <div class="form-floating mb-3">
                        <input id="tel" value="<?php echo $_SESSION['login'][0]['SDT']; ?>" type="tel" name="tel" pattern="[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]" class="form-control">
                        <label for="logTel">Số điện thoại</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input id="idNumber" value="<?php echo $_SESSION['login'][0]['CMND']; ?>" type="text" name="idNumber" class="form-control">
                        <label for="logTel">Số hộ chiếu/CMND/CCCD</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input id="address" value="<?php echo $_SESSION['login'][0]['DiaChi']; ?>" type="text" name="address" class="form-control">
